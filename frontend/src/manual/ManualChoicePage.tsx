...
import { Play, Key, FilePlus, CheckCircle, FileText, Receipt, Printer, Settings, FileCheck, AlertTriangle, ListTodo, Lock } from 'lucide-react';
...
const ManualChoicePage: React.FC = () => {
  ...
  const manuals = [
    ...
    {
      path: '/manual/add-plomb',
      title: 'Как добавить фото пломбы',
      desc: 'Отправка фото замка и пломбы к заказу',
      icon: <Lock size={24} />,
      color: 'text-cyan-600 bg-cyan-100 dark:text-cyan-300 dark:bg-cyan-900/30'
    },
    {
