...
const KazakhFuelPage: React.FC = () => {
  const stations: Station[] = fuelData.kazakhstan;

  return (
    <div className="bg-[#141414] min-h-screen text-white p-4">
      <h1 className="text-2xl font-bold mb-4">Схемы заправок для казахского тягача</h1>
      <ul>
