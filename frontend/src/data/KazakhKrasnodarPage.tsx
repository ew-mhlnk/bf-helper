...
const KazakhKrasnodarPage: React.FC = () => {
  return (
    <div className="bg-[#141414] min-h-screen text-white p-4">
      <h1 className="text-2xl font-bold mb-4">Схема заправок для Краснодара (Казахский тягач)</h1>
      <p>Qazaq Oil AZS #1</p>
...
export default KazakhKrasnodarPage;