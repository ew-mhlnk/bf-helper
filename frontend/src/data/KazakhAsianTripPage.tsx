...
// ID для всех аккордеонов (и Туда, и Обратно)
      ...
      <div className="space-y-4 pb-8">
        ...
        {activeTab === 'there' && (
          <div className="animate-in fade-in slide-in-from-left-4 duration-300 space-y-4">
            ...
            <section className="mt-4">
              <SectionHeader title="🇷🇺 Пограничные переходы" color="text-blue-600 dark:text-blue-400" />
        ...
        {activeTab === 'back' && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-4">
            ...
            {/* ФИНИШ (Ермаки - Последняя точка) */}
            <section className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-800">
              <SectionHeader title="🇷🇺 Ермаки (Перед РБ)" color="text-green-600 dark:text-green-400" />
              <StationCard 
                title="Ермаки"
                coords="54.843884, 31.674989"
                payment="E1 Card"
